...
const SEED_USERS: SeedUser[] = [
  { id: IDS.jeremy, email: 'jeremy@lilnas.com' },
  { id: IDS.monica, email: 'monica@lilnas.com' },
]
...
async function seed() {
  ...
  console.log(`  Jeremy: jeremy@lilnas.com / ${DEV_PASSWORD}`)
  console.log(`  Monica: monica@lilnas.com / ${DEV_PASSWORD}`)
