...
#
# Spins up a disposable Postgres container, pushes the schema, seeds dev
# data, then starts the Next.js dev server. The container is torn down
# regardless of how the process exits (success, failure, or Ctrl+C).
# ---------------------------------------------------------------------------

CONTAINER_NAME="sync-dev-db"
...
DATABASE_URL="$DATABASE_URL" npx tsx src/db/seed.ts
