...
export function buildExtractReminderPrompt(
  ...
  return new SystemMessage(dedent`
    ...
    Examples:
    - "remind me to pay back my friend tomorrow" → {"action":"create","what":"pay back my friend","isRecurring":false,"day":"tomorrow","time":null,"recurringPattern":null,"scheduledAt":"2026-03-18T09:00:00","cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me for my appointment next Monday at 10am" → {"action":"create","what":"appointment","isRecurring":false,"day":"next Monday","time":"10:00 AM","recurringPattern":null,"scheduledAt":"2026-03-23T10:00:00","cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me to take out the trash in 30 minutes" (current time: 2026-03-17T14:00:00) → {"action":"create","what":"take out the trash","isRecurring":false,"day":"today","time":"in 30 minutes","recurringPattern":null,"scheduledAt":"2026-03-17T14:30:00","cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me to call mom in 2 hours" (current time: 2026-03-17T10:15:00) → {"action":"create","what":"call mom","isRecurring":false,"day":"today","time":"in 2 hours","recurringPattern":null,"scheduledAt":"2026-03-17T12:15:00","cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me every week on Tuesday that I am a cool person" → {"action":"create","what":"I am a cool person","isRecurring":true,"day":"every Tuesday","time":null,"recurringPattern":"every week on Tuesday","scheduledAt":null,"cronExpression":"0 9 * * 2","reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me to buss on @Jambalaya Jesus every two minutes starting today" (today is Tuesday) → {"action":"create","what":"buss on @Jambalaya Jesus","isRecurring":true,"day":"today","time":null,"recurringPattern":"every 2 minutes starting today","scheduledAt":null,"cronExpression":"*/2 * * * *","reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me to exercise every day starting tomorrow" → {"action":"create","what":"exercise","isRecurring":true,"day":"tomorrow","time":null,"recurringPattern":"every day starting tomorrow","scheduledAt":null,"cronExpression":"0 9 * * *","reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me every Monday starting next week" (today is Tuesday) → {"action":"create","what":null,"isRecurring":true,"day":"next Monday","time":null,"recurringPattern":"every Monday starting next week","scheduledAt":null,"cronExpression":"0 9 * * 1","reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "remind me every Tuesday starting next week" (today is Tuesday) → {"action":"create","what":null,"isRecurring":true,"day":"next Tuesday","time":null,"recurringPattern":"every Tuesday starting next week","scheduledAt":null,"cronExpression":"0 9 * * 2","reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    ...
    - "remind <@123456789012345678> that the meeting starts now" (current time: 2026-03-17T14:00:00) → {"action":"create","what":"the meeting starts now","isRecurring":false,"day":"today","time":"now","recurringPattern":null,"scheduledAt":"2026-03-17T14:00:00","cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":"123456789012345678","actionType":"default"}
    - "remind <@987654321098765432> about the dentist tomorrow at 3pm" → {"action":"create","what":"the dentist","isRecurring":false,"day":"tomorrow","time":"3:00 PM","recurringPattern":null,"scheduledAt":"2026-03-18T15:00:00","cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":"987654321098765432","actionType":"default"}
    - "show me my reminders" → {"action":"list","what":null,"isRecurring":null,"day":null,"time":null,"recurringPattern":null,"scheduledAt":null,"cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
    - "cancel my reminder about the dentist" → {"action":"cancel","what":"dentist","isRecurring":null,"day":null,"time":null,"recurringPattern":null,"scheduledAt":null,"cronExpression":null,"reminderIdToCancel":null,"channelId":null,"targetUserId":null,"actionType":"default"}
