...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cns(
      ...
      'bg-white p-1 text-neutral-950 shadow-lg',
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cns(
        ...
        'overflow-y-auto overflow-x-hidden rounded-md border border-neutral-200',
        'bg-white p-1 text-neutral-950 shadow-md',
        'dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
        'data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cns('ml-auto text-xs tracking-widest opacity-60', className)}
      {...props}
    />
  )
}
