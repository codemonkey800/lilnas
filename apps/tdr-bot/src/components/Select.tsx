...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cns(
      ...
      'rounded-md border border-neutral-200 bg-transparent',
      'px-3 py-2 text-sm shadow-sm ring-offset-white',
      'data-[placeholder]:text-neutral-500',
      'focus:outline-none focus:ring-1 focus:ring-neutral-950',
      'disabled:cursor-not-allowed disabled:opacity-50',
      '[&>span]:line-clamp-1',
      'dark:border-neutral-800 dark:ring-offset-neutral-950',
      'dark:data-[placeholder]:text-neutral-400 dark:focus:ring-neutral-300',
      className,
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cns('px-2 py-1.5 text-sm font-semibold', className)}
    {...props}
  />
))
