...
CREATE TABLE `__new_events` (
	...
	CONSTRAINT "events_type_check" CHECK("__new_events"."type" IN ('session_created','session_evicted','turn_started','turn_completed','turn_cancelled','turn_errored','turn_interrupted','bot_restart','command_anomaly','transcript_write_failed','git_push_blocked','git_key_decrypt_failed')),
