...
export function ExerciseCard({
  ...
  return (
    ...
    >
      {/* Card header: drag handle + type selector/badge + remove control */}
      <div className="mb-3 flex items-center gap-2">
        ...
        {typeLocked ? (
          <span className="rounded-md bg-neutral-800 px-2 py-0.5 text-xs font-medium uppercase tracking-wide text-neutral-300">
            {EXERCISE_TYPE_LABELS[card.type]}
          </span>
        ) : (
