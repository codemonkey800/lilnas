...
- No `docs/archive/solutions/` entry. The FSM is internal swole logic, not a monorepo-wide reusable pattern. The first `docs/archive/solutions/` entry is reserved for Survivor 3's SQLite-in-monorepo writeup.
