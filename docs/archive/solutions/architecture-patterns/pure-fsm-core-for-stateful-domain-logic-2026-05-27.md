...
- `docs/archive/brainstorms/2026-05-26-swole-session-machine-requirements.md` — R1–R21 requirements.
- `docs/archive/plans/2026-05-26-002-feat-swole-session-machine-plan.md` — U1–U6 implementation slices, named test fixtures.
- `docs/archive/prds/swole.md` — the eight button labels, four exercise types, "single device of truth" persistence model.
- `docs/archive/ideation/2026-05-26-swole-next-build-chunk-ideation.md` — selected the FSM as the next build chunk on the "logic is the bug surface, not infra" rationale.
