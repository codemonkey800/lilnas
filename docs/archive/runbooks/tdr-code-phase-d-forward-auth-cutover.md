...
(`docs/archive/plans/2026-07-02-001-feat-tdr-code-phase-d-auth-plan.md`, Implementation Unit U7) makes
...
`docs/archive/runbooks/tdr-code-phase-d-cutover-verification.md` (created by U5) is the **manual
...
- **Out of scope — do not invent these while executing this runbook:**
  - Any systemd/pm2/process-supervisor change. Phase A's tmux-pane process model
    (`docs/archive/plans/2026-06-29-001-feat-tdr-code-two-process-substrate-plan.md`) is an accepted scope
...
| C   | A guild member completes the full OAuth flow and reaches a guarded read.                                                                     | **Do not re-derive this here** — run `docs/archive/runbooks/tdr-code-phase-d-cutover-verification.md` §2 ("Sign in as a real guild member") and record its own Run Log entry.                                                                      |
| D   | A non-member is rejected with no working session.                                                                                            | **Do not re-derive this here** — run `docs/archive/runbooks/tdr-code-phase-d-cutover-verification.md` §3 ("Attempt sign-in as a real non-member Discord account").                                                                                 |
...
- This document (`docs/archive/runbooks/tdr-code-phase-d-forward-auth-cutover.md`) — new.
...
`docs/archive/runbooks/tdr-code-phase-d-cutover-verification.md`'s own Run Log.
