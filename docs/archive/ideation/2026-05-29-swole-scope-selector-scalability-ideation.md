...
No UI/selector learning exists in `docs/archive/solutions/` yet — this is a fresh decision and `/ce-compound` material once built (the first UI-layer learning). Adjacent: `docs/archive/ideation/2026-05-29-swole-stats-index-overview-ideation.md` (the stats-page overview work that produced this selector, commits U6–U11).
