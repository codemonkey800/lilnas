...
date: 2026-05-28
deepened: 2026-05-28
origin: docs/archive/brainstorms/2026-05-28-swole-exercise-catalog-requirements.md
---
...
Free text has two costs (see origin: `docs/archive/brainstorms/2026-05-28-swole-exercise-catalog-requirements.md`):
...
Carried from origin (`docs/archive/brainstorms/2026-05-28-swole-exercise-catalog-requirements.md`).
...
- Transcribe the v1 contents **verbatim** from origin's "Catalog Contents (v1)" section
  (`docs/archive/brainstorms/2026-05-28-swole-exercise-catalog-requirements.md`, lines 153–183):
...
- **Origin document:** [docs/archive/brainstorms/2026-05-28-swole-exercise-catalog-requirements.md](../brainstorms/2026-05-28-swole-exercise-catalog-requirements.md)
...
- Prior plan (builder this extends): `docs/archive/plans/2026-05-28-001-feat-swole-routine-builder-plan.md`
- Institutional learnings: `docs/archive/solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md`, `docs/archive/solutions/conventions/begin-immediate-for-read-then-write-mutations-2026-05-27.md`
