...
date: 2026-05-27
deepened: 2026-05-27
origin: docs/archive/brainstorms/2026-05-27-swole-data-layer-requirements.md
---
...
The brainstorm (origin: `docs/archive/brainstorms/2026-05-27-swole-data-layer-requirements.md`) settled all of those product/architectural choices. This plan turns those decisions into ordered, file-by-file implementation slices with concrete test scenarios.
...
- No `docs/archive/solutions/` entry. The brainstorm's "first `docs/archive/solutions/` entry reserved for Survivor 3 SQLite-in-monorepo writeup" is a `ce-compound` follow-up after this PR lands and proves out — not part of the implementation.
...
- **`docs/archive/plans/2026-05-26-002-feat-swole-session-machine-plan.md`** — Survivor 2 plan; sets the style precedent for U-IDs, test-scenario granularity, and per-unit verification.
...
- **Origin document:** [docs/archive/brainstorms/2026-05-27-swole-data-layer-requirements.md](../brainstorms/2026-05-27-swole-data-layer-requirements.md)
- **PRD:** [docs/archive/prds/swole.md](../prds/swole.md)
...
- **Institutional learning:** [docs/archive/solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md](../solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md)
- **External docs:**
