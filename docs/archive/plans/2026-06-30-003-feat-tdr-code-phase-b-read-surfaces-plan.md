...
- `docs/archive/solutions/logic-errors/archived-routine-session-missing-set-logs-2026-06-02.md` —
...
- `docs/archive/solutions/logic-errors/consistency-percent-window-mismatch-2026-05-30.md` — a
...
- `docs/archive/solutions/integration-issues/recharts-categorical-axis-same-day-collapse-2026-05-30.md`
...
- **Post-merge:** run `/ce-compound` to capture the net-new patterns this plan establishes
  ...
  `docs/archive/solutions/` base currently has nothing on read-API/UI conventions for this app.
...
- **Institutional:** `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md`,
  `docs/archive/solutions/logic-errors/archived-routine-session-missing-set-logs-2026-06-02.md`,
  `docs/archive/solutions/logic-errors/consistency-percent-window-mismatch-2026-05-30.md`,
  `docs/archive/solutions/integration-issues/recharts-categorical-axis-same-day-collapse-2026-05-30.md`,
  `docs/archive/solutions/conventions/begin-immediate-for-read-then-write-mutations-2026-05-27.md`
