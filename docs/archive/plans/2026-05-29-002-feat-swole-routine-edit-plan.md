...
status: active
date: 2026-05-29
origin: docs/archive/brainstorms/2026-05-29-swole-routine-edit-requirements.md
---
...
The chosen model (see origin: `docs/archive/brainstorms/2026-05-29-swole-routine-edit-requirements.md`)
...
- After this lands, the Next.js App Router unsaved-changes/`beforeunload` guard and the server-component load + `redirect` flow are good `/ce-compound` candidates (undocumented in `docs/archive/solutions/` today, and the next swole feature will hit the same questions).
...
- **Origin document:** [docs/archive/brainstorms/2026-05-29-swole-routine-edit-requirements.md](docs/archive/brainstorms/2026-05-29-swole-routine-edit-requirements.md)
