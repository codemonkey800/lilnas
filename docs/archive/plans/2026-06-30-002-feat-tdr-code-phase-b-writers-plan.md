...
(`docs/archive/plans/2026-06-30-001-feat-tdr-code-phase-b-persistence-schema-plan.md`: *"the insert/append/
...
- `docs/archive/solutions/conventions/begin-immediate-for-read-then-write-mutations-2026-05-27.md` — `IMMEDIATE`
...
- `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md` — model the
  ...
  them, never `row.col!`.
- `docs/archive/solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md` — keep
...
- `docs/archive/solutions/ui-bugs/drawer-history-marker-repush-on-keystroke-2026-05-30.md` (generalized) —
