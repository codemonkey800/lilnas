...
Requirements this plan must satisfy (from origin `docs/archive/brainstorms/2026-06-27-tdr-code-web-ui-requirements.md`):
...
- `docs/archive/solutions/conventions/begin-immediate-for-read-then-write-mutations-2026-05-27.md` — use
...
- `docs/archive/solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md` — model the
...
- `docs/archive/solutions/conventions/atomicity-tests-must-reach-the-write-phase-2026-06-03.md` — rollback tests must
...
- `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md` — the
...
- `docs/archive/solutions/ui-bugs/drawer-history-marker-repush-on-keystroke-2026-05-30.md` (generalized) — every
...
- `docs/archive/solutions/architecture-patterns/expose-external-compose-via-lilnas-proxy-2026-06-25.md` — if/when
...
- **Post-Phase-A `/ce-compound` candidates:** there is currently **no** documented learning for cross-process
  SQLite contention or Node child-process supervision in `docs/archive/solutions/`. After this lands, capture (1) the
...
- **Institutional learnings:** `docs/archive/solutions/conventions/begin-immediate-for-read-then-write-mutations-2026-05-27.md`,
  ...
  `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md`,
  `docs/archive/solutions/ui-bugs/drawer-history-marker-repush-on-keystroke-2026-05-30.md`,
