...
date: 2026-07-03
deepened: 2026-07-03
origin: docs/archive/brainstorms/2026-07-03-tdr-code-structured-logging-requirements.md
---
...
- R15. A `docs/archive/solutions/` pattern doc captures the whole convention. The typed registry is the compile-time floor; an ESLint rule is desirable but deferred (see Scope Boundaries).
...
- **No direct prior art.** `ce-learnings-researcher` found zero learnings on pino, nestjs-pino, redaction, NestJS logger migration, Loki, or tdr-code telemetry. Two conceptual analogues transfer:
  - `docs/archive/solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md` — validates the "framework-free shared module consumed by every plane" instinct.
  - `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md` — compiler-enforced narrowing over casts; a strict `LogEvent` union makes an off-registry slug a compile error.
...
**Files:**
- Create: `docs/archive/solutions/conventions/tdr-code-structured-logging-convention-2026-07-03.md`
...
**Patterns to follow:**
- Existing `docs/archive/solutions/conventions/*.md` frontmatter + slug + date format.

**Test scenarios:**
- Test expectation: none — documentation, no behavioral change.

**Verification:**
- Doc exists under `docs/archive/solutions/conventions/`, frontmatter valid, covers every element listed.
...
- **U8** delivers the durable convention doc under `docs/archive/solutions/conventions/`, including the (cross-plane) redaction control hierarchy.
...
- **Origin document:** [docs/archive/brainstorms/2026-07-03-tdr-code-structured-logging-requirements.md](../brainstorms/2026-07-03-tdr-code-structured-logging-requirements.md)
...
- Institutional analogues: `docs/archive/solutions/architecture-patterns/pure-fsm-core-for-stateful-domain-logic-2026-05-27.md`, `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md`
