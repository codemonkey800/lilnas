...
date: 2026-06-27
deepened: 2026-06-27
origin: docs/archive/brainstorms/2026-06-27-tdr-code-typing-images-requirements.md
---
...
Two UX gaps limit tdr-code today (see origin: `docs/archive/brainstorms/2026-06-27-tdr-code-typing-images-requirements.md`):
...
- Eliminating the brief typing flicker between back-to-back queued turns by re-arming typing in `onPromptStart` — depends on the stop/clear plan's `onPromptStart` callback landing (`docs/archive/plans/2026-06-27-001-feat-tdr-code-stop-clear-plan.md`). Until then the flicker is accepted (see Key Technical Decisions).
...
- `docs/archive/solutions/conventions/atomicity-tests-must-reach-the-write-phase-2026-06-03.md` — race tests must inject the contended event *inside* the real window or they pass vacuously. Shapes the U1 dedupe/teardown race tests (e.g. fire `stopTyping` after `startTyping` but before `fetchChannel` resolves).
...
- **Origin document:** [docs/archive/brainstorms/2026-06-27-tdr-code-typing-images-requirements.md](docs/archive/brainstorms/2026-06-27-tdr-code-typing-images-requirements.md)
...
- **Sibling plan (coordination):** `docs/archive/plans/2026-06-27-001-feat-tdr-code-stop-clear-plan.md`
...
- **Learnings:** `docs/archive/solutions/ui-bugs/drawer-history-marker-repush-on-keystroke-2026-05-30.md`, `docs/archive/solutions/conventions/atomicity-tests-must-reach-the-write-phase-2026-06-03.md`
