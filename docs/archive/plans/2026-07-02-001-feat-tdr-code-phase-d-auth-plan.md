...
- **`docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md`** — a
...
- **`docs/archive/solutions/conventions/atomicity-tests-must-reach-the-write-phase-2026-06-03.md`** — the
...
- **No tdr-code-specific `docs/archive/solutions/` entries exist yet** — Phase A/B/C knowledge lives only in
  `docs/archive/plans/`. The fail-closed provisioning seam, the two-writer WAL interaction, and the
...
- **`/ce-compound` candidates once landed:** the fail-closed provisioning seam (better-sqlite3 async-
  ...
  auth → Loki status is the boundary monitor" insight — none currently captured in `docs/archive/solutions/`.
...
- **Institutional:** `docs/archive/solutions/conventions/type-guards-over-nonnull-assertions-on-db-rows-2026-05-30.md`,
