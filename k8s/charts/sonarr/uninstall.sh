#!/bin/bash
# Uninstall the sonarr Helm chart
...
echo "=== WARNING ==="
echo "This will uninstall the sonarr Helm chart and remove all associated resources."
echo ""
...
echo "  - PersistentVolumeClaim: ${RELEASE_NAME} (contains Sonarr data)"
echo ""
echo "IMPORTANT: Your Sonarr configuration and series data will be preserved"
echo "on the host filesystem at /mnt/hdd1/data/media/sonarr/"
echo ""
...
echo "• Sonarr configuration data is preserved at /mnt/hdd1/data/media/sonarr/"
echo "• Series database and settings will be available when redeploying"
echo "• Any active downloads were interrupted and may need to be restarted"
echo "• TLS certificates may be retained for reuse if the same hostname is used again"
echo ""
echo "Your data location on the host:"
echo "  /mnt/hdd1/data/media/sonarr/"
echo "  ├── config.xml          (main configuration)"
echo "  ├── sonarr.db            (series database)"
echo "  ├── logs/                (application logs)"
echo "  └── Backups/             (automatic backups)"
echo ""
echo "To check existing data:"
echo "  ls -la /mnt/hdd1/data/media/sonarr/"
echo ""
echo "To redeploy sonarr service:"
echo "  ./deploy.sh"
echo ""
...
echo "• If using with SABnzbd/NZBGet, update their configuration"
echo "• Other media services may need Sonarr configuration updated"